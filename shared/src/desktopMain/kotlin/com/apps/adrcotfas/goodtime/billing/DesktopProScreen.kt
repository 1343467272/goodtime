...
@Composable
internal fun DesktopProScreen(onNavigateBack: () -> Unit) {
    ...
    Scaffold(
        ...
        Column(
            ...
            Column(
                ...
                Button(
                    onClick = { urlOpener.openUrl(BUY_ME_A_COFFEE_URL) },
                ) {
                    Text(stringResource(Res.string.support_donate_desc))
                }
                Button(
                    onClick = { urlOpener.openUrl(PAYPAL_URL) },
                ) {
                    Text("PayPal")
                }
                Button(
                    onClick = { urlOpener.openUrl(BTC_URL) },
                ) {
                    Text("Bitcoin")
                }
            }
